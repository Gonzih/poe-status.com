...
var o9474 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9474["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9475 = temp__5718__auto____$1;
return (o9475["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8547__auto__ = f;
return (o__8547__auto__["toString"]).call(o__8547__auto__);
} else {
return "";
}
}catch (e9476){var _ = e9476;
return "";
}});
...
try{var o__8547__auto___9478 = t;
(o__8547__auto___9478["cljs$lang$ctorPrWriter"]).call(o__8547__auto___9478,t,writer);
}catch (e9477){var __9479 = e9477;
}
...
var char_code = (function (){var o__8547__auto__ = (new String(char$));
return (o__8547__auto__["charCodeAt"]).call(o__8547__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8547__auto__ = String;
return (o__8547__auto__["fromCharCode"]).call(o__8547__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9480 = num_code;
switch (G__9480) {
case (1):
return (185);
...
var o__8547__auto__ = String;
return (o__8547__auto__["fromCharCode"]).call(o__8547__auto__,superscript_code);
});
/**
...
}catch (e9482){var _e__8554__auto__ = e9482;
return false;
}})())){
...
var vec__9483 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9483,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o9486 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9486["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9487 = temp__5718__auto____$1;
return (o9487["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___9494 = arguments.length;
var i__4532__auto___9495 = (0);
while(true){
if((i__4532__auto___9495 < len__4531__auto___9494)){
args__4534__auto__.push((arguments[i__4532__auto___9495]));

var G__9496 = (i__4532__auto___9495 + (1));
i__4532__auto___9495 = G__9496;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9490){
var vec__9491 = p__9490;
var ns_detector = cljs.core.nth.call(null,vec__9491,(0),null);
...
var G__9497 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9498 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9497;
remaining_tokens = G__9498;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9488){
...
var vec__9502 = cljs.core.split_with.call(null,(function (p1__9501_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9501_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9502,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9502,(1),null);
...
var vec__9505 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9505,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9505,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9508 = cljs.core.rest.call(null,remaining_tokens);
var G__9509 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9508;
name_tokens = G__9509;
continue;
} else {
...
var vec__9512 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9512,(0),null);
var arity = cljs.core.nth.call(null,vec__9512,(1),null);
var vec__9515 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9515,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9515,(1),null);
var vec__9518 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9518,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9518,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9518,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9518,(3),null);
...
var vec__9524 = result;
var munged_ns = cljs.core.nth.call(null,vec__9524,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__9524,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__9524,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__9524,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__9524,(4),null);
var arity = cljs.core.nth.call(null,vec__9524,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__9528 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__9528,(0),null);
var args = cljs.core.nth.call(null,vec__9528,(1),null);
var vec__9531 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__9531,(0),null);
var name = cljs.core.nth.call(null,vec__9531,(1),null);
...
var G__9534 = (arity + (1));
var G__9535 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9536){
var vec__9537 = p__9536;
var arity = cljs.core.nth.call(null,vec__9537,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__9537,(1),null);
...
return cljs.core.get.call(null,arities,p1__9540_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__9541_SHARP_);
...
args__4534__auto__.push((arguments[i__4532__auto___9549]));
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9544){
var vec__9545 = p__9544;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__9545,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9542){
var G__9543 = cljs.core.first.call(null,seq9542);
var seq9542__$1 = cljs.core.next.call(null,seq9542);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9543,seq9542__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__9553__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__9553__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__9553__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__9553__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9554 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__9554,(0),null);
var fn_name = cljs.core.nth.call(null,vec__9554,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__9554,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__9554,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__9554,(4),null);
var arity = cljs.core.nth.call(null,vec__9554,(5),null);
...
var o__8547__auto__ = f;
return (o__8547__auto__["getBasis"]).call(o__8547__auto__);
});
/**
...
}catch (e9558){var _e__8554__auto__ = e9558;
...
var G__9559 = (obj[cljs.core.first.call(null,path)]);
var G__9560 = cljs.core.rest.call(null,path);
obj = G__9559;
path = G__9560;
continue;
} else {
...
return (function (accum,p__9561){
var vec__9562 = p__9561;
var bit = cljs.core.nth.call(null,vec__9562,(0),null);
var protocol = cljs.core.nth.call(null,vec__9562,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9565){
var vec__9566 = p__9565;
var ns = cljs.core.nth.call(null,vec__9566,(0),null);
var name = cljs.core.nth.call(null,vec__9566,(1),null);
var selector = cljs.core.nth.call(null,vec__9566,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__9571,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__9571,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__9571,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__9569_SHARP_){
return (obj[cljs.core.first.call(null,p1__9569_SHARP_)]);
});})(name,sorted_matches,vec__9571,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
