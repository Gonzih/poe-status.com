...
}catch (e11959){var _e = e11959;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___11962 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___11962)){
var seen_errors_11963 = temp__5718__auto___11962;
if(cljs.core.truth_(seen_errors_11963.has(self))){
} else {
seen_errors_11963.add(self);

var temp__5720__auto___11964 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___11964)){
var sense_11965 = temp__5720__auto___11964;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11965)].join('');
} else {
}
}
} else {
