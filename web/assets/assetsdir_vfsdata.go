...
var AssetsDir = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 1, 8, 14, 26, 22, 99093432, time.UTC),
		},
		"/css": &vfsgen۰DirInfo{
			name:    "css",
			modTime: time.Date(2019, 1, 8, 14, 26, 22, 99093432, time.UTC),
